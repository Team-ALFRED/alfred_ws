...
if("TRUE" STREQUAL "TRUE")
  set(bwi_tools_SOURCE_PREFIX /home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_tools)
  set(bwi_tools_DEVEL_PREFIX /home/avengineer/alfred_ws/sim_alfred/devel)
  ...
  set(bwi_tools_INSTALL_PREFIX /home/avengineer/alfred_ws/sim_alfred/install)
...
if(NOT "/home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_tools/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(bwi_tools_INCLUDE_DIRS "")
  set(_include_dirs "/home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_tools/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bwi_tools' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bwi_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_tools/${idir}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
    _list_append_unique(bwi_tools_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "bwi_tools;bwi_tools_json;/usr/lib/x86_64-linux-gnu/libopencv_videostab.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_video.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_superres.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_stitching.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_photo.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ocl.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_objdetect.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_ml.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_legacy.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_imgproc.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_highgui.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_gpu.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_flann.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_features2d.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_core.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_contrib.so.2.4.8;/usr/lib/x86_64-linux-gnu/libopencv_calib3d.so.2.4.8")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bwi_tools_dep}_FOUND)
      find_package(${bwi_tools_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bwi_tools_dep} REQUIRED ${depend_list})
  endif()
