...
if("TRUE" STREQUAL "TRUE")
  set(bwi_logging_SOURCE_PREFIX /home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_logging)
  set(bwi_logging_DEVEL_PREFIX /home/avengineer/alfred_ws/sim_alfred/devel)
  ...
  set(bwi_logging_INSTALL_PREFIX /home/avengineer/alfred_ws/sim_alfred/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'bwi_logging' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'bwi_logging' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avengineer/alfred_ws/sim_alfred/src/bwi_common/bwi_logging/${idir}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
...
set(depends "roscpp;message_filters;sensor_msgs;nav_msgs;geometry_msgs")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${bwi_logging_dep}_FOUND)
      find_package(${bwi_logging_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${bwi_logging_dep} REQUIRED ${depend_list})
  endif()
