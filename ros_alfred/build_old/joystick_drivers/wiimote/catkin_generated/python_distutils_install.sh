...
cd "/home/avengineer/alfred_ws/ros_alfred/src/joystick_drivers/wiimote"
...
/usr/bin/env \
    ...
    build --build-base "/home/avengineer/alfred_ws/ros_alfred/build/joystick_drivers/wiimote" \
    install \
    $DESTDIR_ARG \
