...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/avengineer/alfred_ws/ros_alfred/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/avengineer/alfred_ws/ros_alfred/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/avengineer/alfred_ws/ros_alfred/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'avengineer <avengineer@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avengineer/alfred_ws/ros_alfred/src/simple_navigation_goals/${idir}'.  Ask the maintainer 'avengineer <avengineer@todo.todo>' to fix it.")
    endif()
