...
if("TRUE" STREQUAL "TRUE")
  set(segbot_simulation_apps_SOURCE_PREFIX /home/avengineer/alfred_ws/ros_alfred/src/segbot_simulation_apps)
  set(segbot_simulation_apps_DEVEL_PREFIX /home/avengineer/alfred_ws/ros_alfred/devel)
  ...
  set(segbot_simulation_apps_INSTALL_PREFIX /home/avengineer/alfred_ws/ros_alfred/install)
...
if(NOT "/home/avengineer/alfred_ws/ros_alfred/src/segbot_simulation_apps/include;/usr/include " STREQUAL " ")
  set(segbot_simulation_apps_INCLUDE_DIRS "")
  set(_include_dirs "/home/avengineer/alfred_ws/ros_alfred/src/segbot_simulation_apps/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'segbot_simulation_apps' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'segbot_simulation_apps' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avengineer/alfred_ws/ros_alfred/src/segbot_simulation_apps/${idir}'.  Ask the maintainer 'Piyush Khandelwal <piyushk@gmail.com>, Jack O'Quin <jack.oquin@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${segbot_simulation_apps_dep}_FOUND)
      find_package(${segbot_simulation_apps_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${segbot_simulation_apps_dep} REQUIRED ${depend_list})
  endif()
