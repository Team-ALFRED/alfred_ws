...
if("TRUE" STREQUAL "TRUE")
  set(ps3joy_SOURCE_PREFIX /home/avengineer/alfred_ws/ros_alfred/src/joystick_drivers/ps3joy)
  set(ps3joy_DEVEL_PREFIX /home/avengineer/alfred_ws/ros_alfred/devel)
  set(ps3joy_INSTALL_PREFIX "")
  set(ps3joy_PREFIX ${ps3joy_DEVEL_PREFIX})
else()
  set(ps3joy_SOURCE_PREFIX "")
  set(ps3joy_DEVEL_PREFIX "")
  set(ps3joy_INSTALL_PREFIX /home/avengineer/alfred_ws/ros_alfred/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avengineer/alfred_ws/ros_alfred/src/joystick_drivers/ps3joy/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ps3joy_dep}_FOUND)
      find_package(${ps3joy_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ps3joy_dep} REQUIRED ${depend_list})
  endif()
